...
const PAGE_TEMPLATE = {
  name: 'about-us',
  description: 'About Us page: intro banner, article header, image gallery, team testimonial tabs, latest articles cards, FAQ accordion, and a closing CTA hero banner.',
  urls: [
  ...
  sections: [
    {
      id: 'rc1', name: 'Intro banner', selector: '#main-content > header.section.secondary-section', style: 'secondary', blocks: ['columns-intro'], defaultContent: [],
    },
    {
