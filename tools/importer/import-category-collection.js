...
// PARSER IMPORTS
import cardsTrendsParser from './parsers/cards-trends.js';
...
// PAGE TEMPLATE CONFIGURATION - Embedded from page-templates.json (category-collection)
const PAGE_TEMPLATE = {
  ...
  sections: [
    ...
    {
      id: 'rc2', name: 'Trend alert category grid', selector: '#trends', style: null, blocks: ['cards-trends'], defaultContent: ['#trends > div.container > div.utility-text-align-center'],
    },
    {
      id: 'rc3', name: 'Featured article', selector: '#main-content > section.section.secondary-section', style: 'secondary', blocks: ['columns-article'], defaultContent: [],
    },
    {
...
const parsers = {
  ...
  'cards-trends': cardsTrendsParser,
